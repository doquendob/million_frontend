...
const Login = () => {
    return (
        <>
        <Image src={Logo} alt="Your Company" className="mx-auto h-40 w-40" />
        <div className="flex min-h-full flex-col justify-center px-6 py-25 lg:px-8 bg-white">
      
            <div className="sm:mx-auto sm:w-full sm:max-w-sm sm:h-full">
